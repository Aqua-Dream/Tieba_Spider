_.Module.define({
    path: "common/component/UeditorEmotion",
    requires: ["common/component/ScrollPanel", "common/component/CustomEmotion"],
    sub: {
        $container: null,
        _template: {
        ...
        emotionConfig: {
            ...
            ySmile: {
                tip: ["^_^", "(-__-)b", "\u2299\uFE4F\u2299\u2016", "\u2299\u25BD\u2299", " \u2267\u03B5 \u2266", "\u2533\uFF3F\u2533", "(\u256C\u25BC\u76BF\u25BC\uFF09", "\\(&quot;\u2594\u25A1\u2594)/", "\u2196(\uFFE3\u25BD\uFFE3&quot;) ", "(\u3065\uFFE33\uFFE3)\u3065 ", "(*\uFFE3\u25BD\uFFE3)y ", "o(\u2267\u53E3\u2266)o ", "(\uFFE3\u03B5\uFFE3*)", "/(\u3112o\u3112)/~~ ", "(\uFFE3\u03B5\uFFE3*)", "&lt;(\uFFE3\uFE36\uFFE3)&gt; ", "o(\u2267v\u2266)o", "\u256E(\u256F3\u2570)\u256D ", " \uFF61\u25D5\u203F\u25D5\uFF61", " \u7F52\u03C9\u7F52", "(\u25D5\u03C9\uFF1C)\u2606 ", "(\u273F\u272A\u203F\u272A\uFF61)\uFF89 ", "\uFF08\u25D5(\uFF6A)\u25D5\uFF09", "(\u25CF&#039;\u25E1&#039;\u25CF)\uFF89\u2665", "\u03A3(\u3063 Â°\u0414 Â°;)\u3063", "\u311F( \u2594, \u2594 )\u310F", "\u51F8(\u8279\u76BF\u8279 ) ", "m(_ _)m", "(\u2299x\u2299;)", "( =\u2229\u03C9\u2229= )", " \u256E(\u256F\u25BD\u2570)\u256D", "(\u22673\u2266)/ ", "(\uFF20_\uFF20;)?", " o(*\uFFE3\u25BD\uFFE3*)\u30D6", "(o\u309C\u25BD\u309C)o\u2606", "&quot;o((&gt;\u03C9&lt; ))o&quot; "],
                num: 36,
                prev: "",
                folder: "",
                name: "\u989C\u8868\u60C5",
        ...
        initial: function (t) {
            var e = this,
                o = t.container;
            t.customEmotionEnable && (this.emotionConfig.custom.power = 1, this.defaultGroup = "custom"), this.$container = o, this.defaultGroup = t.defaultGroup || e.defaultGroup, o.html(this._template.inner), this.$content = o.find(".j_content"), this.$tab = o.find(".j_tab"), e.scrollPanel = e.use("common/component/ScrollPanel", {
                container: e.$content,
                height: 277,
                content: ""
            }), t.customEmotionEnable && (this.customEmotion = this.use("common/component/CustomEmotion"), this.customEmotion.bind("ok", function () {
            ...
            this.$content.on("mouseleave", ".j_emotion, .j_custom_emotion", function () {
                ...
                "text" == e.data("stype") ? $.stats.sendRequest("ev_type=click&st_mod=editor&st_type=text&st_value=" + e.tbattr("title")) : t.sendStats(e, "click"), t.trigger("insertemotion", o)
            }).on("click", ".j_custom_emotion", function (e) {
                var o = $(e.target);
                if (o.hasClass("j_delete")) {
                    if (confirm("\u786E\u8BA4\u8981\u5220\u9664\u6B64\u8868\u60C5\u5417\uFF1F")) {
                        var s = o.parent().data("surl");
                        t.customEmotion.removeCustomEmotion(s), t.scrollPanel.$content.html(t.generateCustomTable())
                    }
            ...
            try {
                s && "10th" == s && $.stats.track(o, "PC\u7AEF\u5341\u5468\u5E74\u53D1\u5E16\u8868\u60C5\u70B9\u51FB\u7EDF\u8BA1"), -1 != $.inArray(o, i) ? $.stats.sendRequest("st_all=doubleeleven&ev_type=" + e + "&st_mod=editor&st_type=" + s + "&st_value=" + o) : $.stats.sendRequest("ev_type=" + e + "&st_mod=editor&st_type=" + s + "&st_value=" + o)
            } catch (n) {}
        }, getMouseenterHandler: function () {
            function t() {
                var t = e.width(),
                    o = e.height();
                (t > 60 || o > 60) && (t > o ? (e.width(60), e.height(60 * (o / t))) : (e.height(60), e.width(60 * (t / o))));
                var s = (60 - e.width()) / 2,
                    i = (60 - e.height()) / 2;
                e.css({
                    left: s,
            ...
            return function () {
                var s = $(this),
                    i = $(".j_emotion_preview");
                e && e.remove(), s.css("background-color", "#e8e8fd"), "text" !== s.data("stype") && (e = $("<img/>"), e.addClass("review"), e.load(function () {
                    clearTimeout(o), i.show();
                    var n = e.width(),
                        a = e.height();
                    0 == n || 0 == a ? o = setTimeout(arguments.callee, 50) : (t(), 1 == s.data("posflag") && i.addClass("emotion_preview_show"))
                }).error(function () {
                    o = setTimeout(function () {
                        e.tbattr("src", s.data("surl"))
                    }, 50)
                }).tbattr("src", s.data("surl")), i.append(e))
            }
        }, getEmotionFileName: function (t, e, o) {
            return "i_f" == t && e >= 51 && (o = "gif"), t + (10 > e ? "0" : "") + e + "." + o
        }, generateEmotions: function (t) {
            var e = this,
                o = this.scrollPanel,
                s = this.emotionConfig,
                i = s[t],
                n = this.path,
                a = n + i.folder,
                l = i.css.cols,
            ...
            var d, u = i.css["class"],
                ...
                b = this._template.tr,
                v = this._template.tdEmpty,
                g = this._template.td,
                x = this._template.a,
                w = "",
                y = function (t) {
                    for (var o = "", s = 0, n = i.num; n > s;) {
                        for (var d = "", _ = 0; l > _; _++, s++) {
                            var w = e.getEmotionFileName(h, s + 1, f);
                            if (w && n > s) {
                                var y = a + w + "?t=20140803",
                                    j = r > _ ? 0 : 1,
                                    E = p * s * -1;
                                ("lt" == t || "ali" == t) && (E -= 1), "ali" == t && (E += 3);
                                var C = "text" == i.type ? i.tip[s] : "&nbsp;",
                                    T = $.tb.format(x, {
                                        offset: E,
                                        content: C
                                    });
            ...
            d = "custom" == i.type ? this.generateCustomTable() : y(t), w += $.tb.format(_, {
                content: d
            }), o.setContent(w), o.$content.css("height", 277)
            ...
            function e(e, o) {
                var s = [];
                s.push("<tr>");
                for (var i = 0; 10 > i; i++) s.push(t(e[i + o], i));
                return s.push("</tr>"), s.join("")
            }
            var o = this.customEmotion.getCustomEmotions();
            o.push({
                option: "add"
            });
            for (var s = [], i = 0, n = Math.floor(o.length / 10) + 1; n > i; i++) s.push(e(o, 10 * i));
            return "<table class='ue_emotion_table' cellspacing='1'>" + s.join("") + "</table>"
        }, generateTabList: function () {
            for (var t = this.sequence, e = this.emotionConfig, o = this._template.tab, s = this._template.tabItem, i = "", n = 0, a = t.length; a > n; n++) {
                var l = t[n];
                if (e[l].power) {
                    var r = {
